...
using Szkielet.Clocks;
using static Szkielet.Utils;
using BigBen = Szkielet.Clocks.BigBen;
...
namespace Szkielet
{
    public class Shop
    {
        ...
        private List<Clock> _clocks1;

        public Shop()
        {
            Utils.Intro();
            _clocks = new Dictionary<int, Clock>();
            _clocks1 = new List<Clock>();
        }
        ...
        public Dictionary<int, Clock> GenerateClocks(int noOfClocks)
        {
            ...
            while (_clocks.Count < noOfClocks)
            {
                ...
                {
                    case 0:
                        var wallClocks = new WallClock(randHour, randMinute, randSecond);
            ...
            var wallClocks1 = new WallClock(15, 59, 45);
